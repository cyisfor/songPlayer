...
class Q:
	sources = ("queue.c","adjust.c","synchronize.c")
	def added(self,parent):
...
program('done',songdb,queue,"select.c")
program('dscanner',songdb,Pkg.MEDIA)
program('enqueue',queue)
